      ...
      return {
        ...
        centerRouters: [
          ...
          [
            ...
            {url: `${this.getBasePath(process.env.env).basePath}:6110/#/`, imgSrc: 'static/img/menu/bill_center.png', platformId: '12', name: '账单中心'},
            {url: `${this.getBasePath(process.env.env).basePath}:6111/#/`, imgSrc: 'static/img/menu/settlement_center.png', platformId: '13', name: '结算中心'},
