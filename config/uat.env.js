...
module.exports = merge(prodEnv, {
  QUERY_HOST_SYSTEM_CONFIG: '"http://localhost:9101"',// 生产环境host
  COMMAND_HOST_SYSTEM_CONFIG: '"http://localhost:9103"',// 生产环境host
  QUERY_HOST_ORGANIZATION: '"http://localhost:9105"',// 生产环境host
  COMMAND_HOST_ORGANIZATION: '"http://localhost:9107"',// 生产环境host
  QUERY_HOST_ALERT: '"http://localhost:9109"',// 生产环境host
